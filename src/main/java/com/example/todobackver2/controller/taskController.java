...
public class taskController {
    ...
    @CrossOrigin
    public GetAllTasksResponse<List<TaskReponse>> getAllTasks(@PathVariable Long projectId, @RequestParam(value = "page", defaultValue = "0") Integer page, @RequestParam(value = "limit", defaultValue = "7") Integer limit) {
    ...
    @PutMapping("/{taskId}")
    @CrossOrigin
    public TaskDto checkDone(@PathVariable Long taskId){
        TaskDto returnValue=taskService.checkDone(taskId);
        return returnValue;
    }
